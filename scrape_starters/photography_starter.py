...
tab.click()
time.sleep(2)
category_button = driver.find_element_by_xpath('//*[@id="root"]/div/div[4]/div[1]/div[1]/div/div[2]/div[26]/a/img')
category_button.click()

csv_file = open('photography.csv', 'w', encoding='utf-8', newline='')
