...
csv_file = open('hnb.csv', 'w', encoding='utf-8', newline='')
writer = csv.writer(csv_file)

time.sleep(3)
property_button = driver.find_element_by_xpath('//div[7]/a[@class="styles__collectionLink___37_IC styles__link___9msaS"]')
