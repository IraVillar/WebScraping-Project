...
csv_file = open('womens.csv', 'w', encoding='utf-8', newline='')
writer = csv.writer(csv_file)

time.sleep(3)
property_button = driver.find_element_by_xpath('//div[5]/a[@class="styles__collectionLink___37_IC styles__link___9msaS"]')
